...
<form
    method="POST"
    action="{{ !$info->id ? route('ficha.store') : route('ficha.update', ['info'=>$info->id]) }}"
    >
    <div class="card-body">
    @csrf
    @if ( $info->id )
    ...
    @endif
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('nombre_paciente') ?: $info->nombre_paciente }}">
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('apellido_paciente') ?: $info->apellido_paciente }}">
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('telefono_paciente') ?: $info->telefono_paciente }}">
        ...
        <div class="form-group">
            ...
            <select name="select_salud" id="select_salud" class="form-control @error('select_salud') is-invalid @enderror">
                ...
                <option value="{{$s->id}}"
                {{ ( (int) old('select_salud') === $s->id or (int) $info->sistema_saluds_id === $s->id )? 'selected' : ''}}>{{$s->nombre_sistema_salud}}</option>
                @endforeach
            </select>
                @error('select_salud')
                    <span class="error invalid-feedback">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <select name="select_genero" id="select_genero" class="form-control @error('select_genero') is-invalid @enderror">
                ...
                @foreach($genero as $g)
                <option value="{{$g->id}}"
                {{ ( (int) old('select_genero') === $g->id or (int) $info->genero_pacientes_id === $g->id)? 'selected' : ''}}>{{$g->nombre_genero}}</option>
                @endforeach
            </select>
                @error('select_genero')
                    <span class="error invalid-feedback">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <select name="select_ciudad" id="select_ciudad" class="form-control @error('select_ciudad') is-invalid @enderror">
                ...
                <option value="{{$ci->id}}"
                {{ ( (int) old('select_ciudad') === $ci->id or (int) $info->ciudad_pacientes_id === $ci->id)? 'selected' : ''}}>{{$ci->nombre_ciudad}}</option>
                @endforeach
            </select>
                @error('select_ciudad')
                    <span class="error invalid-feedback">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('direccion_paciente') ?: $info->direccion_paciente }}">
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('correo_paciente') ?: $info->correo_paciente }}">
        ...
        <div class="form-group">
            ...
            <input
                ...
                value="{{ old('fecha_nacimiento') ?: $info->fecha_nacimiento }}">
    ...
    <div class="card-footer">
      <button type="submit" class="btn btn-info">
        {{ $info->id ?"Modificar Ficha" : "Crear nueva Ficha"}}
    </button>
    <a href="{{ route('ficha.create') }}" class="btn btn-primary">Agregar nueva Ficha</a>
    </div>
  </form>
